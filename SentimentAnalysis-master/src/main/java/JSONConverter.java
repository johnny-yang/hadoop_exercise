...
public class JSONConverter {
    ...
    public static void main(String[] args) throws IOException, JSONException {
        ...
        BufferedReader br = new BufferedReader(new FileReader("/Users/ValarMorghulis/bigdata-class2/SentimentAnalysis/output/part-r-00000"));
        String line = br.readLine();
        FileWriter fileWriter = new FileWriter("/Users/ValarMorghulis/bigdata-class2/SentimentAnalysis/output/result.json");
